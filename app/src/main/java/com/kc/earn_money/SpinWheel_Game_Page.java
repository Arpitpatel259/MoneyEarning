...
public class SpinWheel_Game_Page extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        llWithdrawMoney.setOnClickListener(v -> {
            startActivity(new Intent(SpinWheel_Game_Page.this, Withdraw_Money_Page.class));
            finish();
        });
    ...
    public void getPaymentDataSpin() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Wallet_Data_Entries").child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                editor.apply();
                startActivity(new Intent(SpinWheel_Game_Page.this, SpinWheel_Game_Page.class));
                finish();
            }
